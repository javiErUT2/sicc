...
<div class="p-20">
    ...
    <div class="">
        <button class="modal_button m-4 bg-[#00ab84] p-2 rounded hover:opacity-50 transition-all hover:scale-110 text-white mt-2" type="submit"> Agregar estudiante
        </button>
    </div>
    <div class="modal">
        <div class="modal__container   bg-[#faf9f9]  sombrita  ">
            <form class="  grid  place-items-center gap-4 p-10 text-center" enctype="multipart/form-data" action="{{url('estudiantes')}}" method="POST">
                <h1 class="font-bold  text-[30px] sombrita-txt text-[#00ab84]">Agregar Alumno</h1>
